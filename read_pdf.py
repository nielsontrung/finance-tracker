...
def valid_transaction(description):
    ...
    """
    not_valid = ["online banking transfer", "online transfer", "e-transfer cancel", "e-transfer sent humptys"
                 "fee", "multiproduct rebate", "withdrawal", "item returned unpaid"]
    for i in not_valid:
        if i in description:
            return False
    return True
